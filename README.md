...
If you want to use JsonPit 3.9.1 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Coordinated patch release: aligns JsonPit with `OsLibCore 3.9.1` and `RaiUtils 3.9.1` in the current dependency order.
...
- No JsonPit API changes were required beyond the `3.9.0` line; this release refreshes the aligned package baseline and packaged docs.
- Live docs and release-note pointers were refreshed for the `3.9.1` release line, and this README is packaged with the NuGet release.
...
- Latest release notes: [RELEASE_NOTES_3.9.1.md](RELEASE_NOTES_3.9.1.md)
