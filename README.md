...
If you want to use JsonPit 4.0.0 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Coordinated major release prep: aligns JsonPit with `OsLibCore 4.0.0` and `RaiUtils 4.0.0` in the current dependency order.
...
- Live docs and release-note pointers were refreshed for the `4.0.0` release line, and this README is packaged with the NuGet release.
...
- Latest release notes: [JsonPit_RELEASE_NOTES_4.0.0.md](https://github.com/Burkhardt/RAIkeep/blob/main/doc/JsonPit_RELEASE_NOTES_4.0.0.md)
