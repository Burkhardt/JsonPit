...
If you want to use JsonPit 3.12.0 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Coordinated minor release: aligns JsonPit with `OsLibCore 3.12.0` and `RaiUtils 3.12.0` in the current dependency order.
...
- No JsonPit API changes were required beyond the `3.11.5` line; this release refreshes the aligned package baseline and packaged docs.
- Live docs and release-note pointers were refreshed for the `3.12.0` release line, and this README is packaged with the NuGet release.
...
- Latest release notes: [RELEASE_NOTES_3.12.0.md](RELEASE_NOTES_3.12.0.md)
