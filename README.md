...
If you want to use JsonPit 3.8.6 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Latest release notes: [RELEASE_NOTES_3.8.6.md](RELEASE_NOTES_3.8.6.md)