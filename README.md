...
If you want to use JsonPit 3.7.9 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Patch: aligns JsonPit with `OsLibCore 3.7.9` and `RaiUtils 3.7.9` in the current publish order.
...
- Live docs and release-note pointers were refreshed for the `3.7.9` release line.
...
- Latest release notes: [RELEASE_NOTES_3.7.9.md](RELEASE_NOTES_3.7.9.md)