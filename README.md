...
If you want to use JsonPit 3.11.4 from NuGet in another service or agent workflow, start with [GettingStarted.md](GettingStarted.md).
...
- Coordinated patch release: aligns JsonPit with `OsLibCore 3.11.4` and `RaiUtils 3.11.4` in the current dependency order.
...
- Live docs and release-note pointers were refreshed for the `3.11.4` release line, and this README is packaged with the NuGet release.
...
- Latest release notes: [RELEASE_NOTES_3.11.4.md](RELEASE_NOTES_3.11.4.md)
