...
Prepared coordinated line: `4.2.4`
...
- Fallback package references align to `OsLibCore 4.2.4` and `RaiUtils 4.2.4`.
...
Release notes: [JsonPit_RELEASE_NOTES_4.2.4.md](https://github.com/Burkhardt/RAIkeep/blob/main/doc/JsonPit_RELEASE_NOTES_4.2.4.md)
