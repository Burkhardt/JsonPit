# Getting Started with JsonPit 3.8.0
...
It is based on the current JsonPit 3.8.0 code and tests in this repository.
...
Use the NuGet package ids at version `3.8.0`:
...
```bash
dotnet add package JsonPit --version 3.8.0
dotnet add package RaiUtils --version 3.8.0
dotnet add package OsLibCore --version 3.8.0
```
