# Getting Started with JsonPit 3.10.0
...
It is based on the current JsonPit 3.10.0 code and tests in this repository.

## 3.10.0 key decisions
...
Use the NuGet package ids at version `3.10.0`:
...
```bash
dotnet add package JsonPit --version 3.10.0
dotnet add package RaiUtils --version 3.10.0
dotnet add package OsLibCore --version 3.10.0
```
