# Getting Started with JsonPit 3.8.1
...
It is based on the current JsonPit 3.8.1 code and tests in this repository.
...
Use the NuGet package ids at version `3.8.1`:
...
dotnet add package RaiUtils --version 3.8.1
dotnet add package OsLibCore --version 3.8.1
```
