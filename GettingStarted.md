# Getting Started with JsonPit 3.11.3
...
It is based on the current JsonPit 3.11.3 code and tests in this repository.

## 3.11.3 key decisions
...
Use the NuGet package ids at version `3.11.3`:
...
```bash
dotnet add package JsonPit --version 3.11.3
dotnet add package RaiUtils --version 3.11.3
dotnet add package OsLibCore --version 3.11.3
```
