# Getting Started with JsonPit 3.8.12
...
It is based on the current JsonPit 3.8.12 code and tests in this repository.

## 3.8.12 key decisions
...
Use the NuGet package ids at version `3.8.12`:
...
```bash
dotnet add package JsonPit --version 3.8.12
dotnet add package RaiUtils --version 3.8.12
dotnet add package OsLibCore --version 3.8.12
```
