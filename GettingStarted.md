# Getting Started with JsonPit 3.8.11
...
It is based on the current JsonPit 3.8.11 code and tests in this repository.

## 3.8.11 key decisions
...
Use the NuGet package ids at version `3.8.11`:
...
```bash
dotnet add package JsonPit --version 3.8.11
dotnet add package RaiUtils --version 3.8.11
dotnet add package OsLibCore --version 3.8.11
```
