# Getting Started with JsonPit 3.11.5
...
It is based on the current JsonPit 3.11.5 code and tests in this repository.

## 3.11.5 key decisions
...
Use the NuGet package ids at version `3.11.5`:
...
```bash
dotnet add package JsonPit --version 3.11.5
dotnet add package RaiUtils --version 3.11.5
dotnet add package OsLibCore --version 3.11.5
```
